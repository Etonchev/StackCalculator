...
Тъй като калкулатора е реализиран със стек, най-удачно е използването на обратен полски запис за извършване на пресмятането. В решението използвам реализация на класа стек и клас Calculator, в който присъстват функциите извършващи пресмятанията. Използвам помощните функции isNumber, isOperator и isSpecial, чрез които се определя входа. Дали е число, оператор или специална дума. След това функциите performOp и performSpecial извършват дадените операции с помощта на класа Calculator.
Като бъдещ проект може да се подобри интерфейса и да се добавят още функции. Също така може да се добави функционалност за решаване на квадратни уравнения, суми и т.н. Може да се добавят и някои математически константи.
